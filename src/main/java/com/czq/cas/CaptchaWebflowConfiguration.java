...
public class CaptchaWebflowConfiguration {
    ...
    public CasWebflowConfigurer defaultLoginWebflowConfigurer(){
        DefaultCaptchaWebflowConfigurer configurer=new DefaultCaptchaWebflowConfigurer(flowBuilderServices,loginFlowRegistry,applicationContext,casConfigurationProperties);
